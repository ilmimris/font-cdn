...
AvailableFonts.prototype.isWeightAvailable = function(family, weight) {
  return this.isFamilyAvailable(family) && this.fontsLookup[family].hasWeight(weight);
};

AvailableFonts.prototype.availableWeights = function(family) {
  return this.fontsLookup[family].weights;
};
