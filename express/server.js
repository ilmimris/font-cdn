...
const AvailableFonts = require('utils').AvailableFonts;
global.fonts = new AvailableFonts();

const FontQueryStringParser = require('utils').FontQueryStringParser;
...
app.use(require('utils').StaticAssetMiddleware);
